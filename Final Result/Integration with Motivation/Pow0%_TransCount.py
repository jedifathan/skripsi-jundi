...
# Updated data
data = {
    'L-L': 0.0031666666666666666,
    'L-M': 0.029166666666666667,
    'L-S': 0.14233333333333334,
    'M-L': 0.0022500000000000003,
    'M-M': 1.3359166666666666,
    'M-S': 3.3954166666666667,
    'S-L': 0.0025833333333333333,
    'S-M': 3.416,
    'S-S': 3.252416666666667
}
...
plt.tight_layout()
plt.savefig('Pow50%_TransCount.png')
plt.show()